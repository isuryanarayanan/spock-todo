...
/* package spock-todo-0.1.0.0 */
#ifndef VERSION_spock_todo
#define VERSION_spock_todo "0.1.0.0"
#endif /* VERSION_spock_todo */
#ifndef MIN_VERSION_spock_todo
#define MIN_VERSION_spock_todo(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_spock_todo */
...
#define CURRENT_COMPONENT_ID "spock-todo-0.1.0.0-inplace-spock-todo"
